      ...
      <div className={`flex flex-col md:flex-row h-full ${darkMode ? 'bg-black text-white' : 'bg-white text-gray-900'}`}>
        ...
        <div className="flex-1 flex flex-col justify-center items-center text-left p-8 md:p-12">
          ...
          <p className="mt-4 text-center">
            As part of the pre-screening process for the full-stack developer position, you are required
            to build a full-stack to-do list application that demonstrates your front-end and back-end development skills.
          </p>
        </div>
